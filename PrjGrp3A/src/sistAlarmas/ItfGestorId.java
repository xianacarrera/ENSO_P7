...
public interface ItfGestorId {
    ...
    // Todos los m�todos est�ticos se pueden implementar directamente
    // en la interfaz desde Java 8


    //TODO A�ADIR AL DICCIONARIO LOS FORMATOS

    /*
     * LAS COMPROBACIONES A REALIZAR BUSCAR�N SER SIMILARES A LAS ESTABLECIDAS
     * EN EL DICCIONARIO DE DATOS ASOCIADO A LA PR�CTICA. POR ELLO, SE COMPROBAR�N:
     * -> ID DISTINTO DE NULL
    ...
    /*TODO A�ADIR AL DICCIONARIO DE DATOS*/

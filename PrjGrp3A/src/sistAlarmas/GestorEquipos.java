...
public class GestorEquipos implements ItfGestorEquipos{
	...
	public Equipo recibirProtocolos(List<Protocolo> prots, Alarma al) throws Exception {
		...
		/* Para mayor claridad, se incluye comentado el c�digo sin programaci�n funcional
		int max = 0;
		String idMax = null;
	...
	public GestorEquipos recibirVerificacion(Equipo equipo, Verificacion verif) throws Exception {
		// En caso de una aplicaci�n con gui, se imprimir�a el mensaje
	...
	// Sobreescritura del método leerVerif de la interfaz ItfGestorEquipos
